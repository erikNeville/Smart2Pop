    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../../../../index.html"><img class="logo" src="../../../../../images/popkids_text8crop.png"></a>
            </div>
		...
		<div class="row">
			<div class="col-sm-6">
				<h3><?php the_title();?></h3>
					...
					<div class="a"><strong>Category &nbsp</strong><?php echo $category;?></div>
					<div class="a"><strong>Age &nbsp</strong><?php echo $age; ?></div>
					<div class="a"><strong>Description &nbsp</strong><?php echo the_content();?></div>
			</div>
			<div class="col-sm-6">	
				...
				<div class="mb-5 text-center"><a href=""><img src="../wordpress/wp-content/themes/products/images/google.png" alt="Google" height="50" width ="50" style="float: middle;"></a>
					<font color="#80bfff">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDownload this app&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</font>
					<a href=""><img src="../wordpress/wp-content/themes/products/images/apple.png" alt="Apple" height="50" width ="50" style="float: middle;"></a></div>					
				<div class="a"></div>				
			</div>
